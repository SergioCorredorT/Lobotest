...
//----------------------------------
			...
			function getValorCSS2(_elemento, _propiedadCSS, _comodin="")
			{
				...
				if(_comodin=="width")
				{//En porcentaje si recibe tercer parámetro width o height según el parámetro segundo
...
//No recomendado
		 ...
		 * NO RECOMENDADO
		 */
		redibujarPantallaGuardada()
		{//Redibujar así implica perder resolución de líneas en caso de que se haya cambiado el tamaño de la pizarra
			if(this.miCanvasPizarra.width>0 && this.miCanvasPizarra.height>0)
			{
...
//	Primarios
		...
		pintarPantallaCompletamente()
		{//Después puedes descubrir fondo borrando
		...
		setModeloAlturaAplicandoLoGuardadoEnSuPosicionAbsoluta(_elementoModeloNuevo)
		{//Antes de usar esta función se debe usar "guardarLineas()" para poder redibujar lo que había antes de la modificación;
